        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-16">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg max-w-[800px] mx-auto">
            ...
            <button
              ...
              className="mt-6 w-full py-4 bg-[#25D366] hover:bg-[#20BD5A] text-white rounded-2xl font-bold transition-all shadow-lg hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-3"
            >
              ...
              <span className="text-sm md:text-base">Send Proof of Payment</span>
            </button>
